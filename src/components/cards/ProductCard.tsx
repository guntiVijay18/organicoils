...
import { ArrowRight, Scale, Check, Leaf } from "lucide-react";
  ...
  return (
    <div className="card-organic group hover:shadow-hover transition-all overflow-hidden">
      ...
      <div className="relative h-48 overflow-hidden bg-muted">
        ...
        {/* Fallback icon */}
        <Leaf className="absolute inset-0 m-auto w-20 h-20 text-primary/30 pointer-events-none" />
        ...
        <button
          ...
          className={`absolute top-3 right-3 p-2 rounded-full transition-all ${
            ...
            !inCompare && compareList.length >= 4
      ...
      <div className="p-5">
        ...
        <div className="flex flex-wrap gap-1 mb-4">
          ...
          {product.problemsSolved.length > 3 && (
            <span className="text-xs text-muted-foreground">
              +{product.problemsSolved.length - 3} more
            </span>
          )}
        </div>
        ...
        <div className="text-xs text-muted-foreground mb-4">
          ...
          {product.suitableCrops.slice(0, 3).join(", ")}
